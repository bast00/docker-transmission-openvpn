# Tuto install
 ...
 - Install docker and docker-compose [Install Compose](https://docs.docker.com/compose/install/linux/)
 - in the project dir : `docker compose up -d`
 - wait for the thing (must take 1h to pull, compile, etc.)
